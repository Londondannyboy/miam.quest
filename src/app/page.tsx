...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950">
      ...
      {/* ========== HERO SECTION ========== */}
      <section className="relative min-h-[90vh] flex items-center bg-gradient-to-br from-rose-950 via-rose-900 to-slate-900">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <Link
                href="/chat"
                className="group inline-flex items-center justify-center gap-3 px-8 py-5 bg-white hover:bg-rose-50 text-rose-700 rounded-2xl font-bold text-lg transition-colors shadow-xl"
              >
